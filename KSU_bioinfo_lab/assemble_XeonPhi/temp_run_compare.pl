...
my $optional_assembled_cmap = '/home/bionano/bionano/Corv_corv_2015_001_de_novo/contigs/exp_refineFinal1/EXP_REFINEFINAL1.cmap'; # add assembled cmap path here if it is not in the "refineFinal1" subdirectory within the "contigs" subdirectory of the best assembly directory
#########################################################################
