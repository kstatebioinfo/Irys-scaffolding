...
# usage: ./mismatch_v2.pl bionano_query_from_component.agp tcas_chromosome_from_component.agp scfTrib_cast_0002_15_.3.AGP contig.map > contigs_of_interest.txt
